 ...
 * This data class uses very small units for each field, so it is very compact, even though it does have a lot of fields.
 *
 ...
 *
 * @constructor Creates a new version with the specified fields.
 *
 * @property verId A unique version ID from `0` to `65535`.
 * @property moduleName A module name which this version belongs to.
 * @property ver A triple with major, minor, and patch, each from `0` to `255`.
 * @property verName A string representation of the [ver] variable, separated with `.`. Automatically generated by default.
 * @property verType The release type of this version. [ReleaseType.RELEASE] by default.
 * @property verPacked A packed version of the [ver] variable into a single [UInt]. `0x0Mmp` by default, where `M` is major, `m` is minor, and `p` is patch.
 * @property jvmRequired The required JVM version to run this version of the [module][moduleName].
 *
 * @author MarcPG
 * @since 0.1.0
 */
